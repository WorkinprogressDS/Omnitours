      ...
      <div className="container" style={{ position: "relative", zIndex: 10, paddingTop: 80, paddingBottom: 80 }}>
        <div style={{ maxWidth: 760 }}>
          ...
          <h1 className="animate-fade-in-up anim-d2" style={{
            ...
            <br />
            <span style={{ color: "var(--text)" }}>Every detail.</span>
            <br />
            <span style={{ color: "var(--text2)", fontWeight: 400, fontSize: "clamp(32px, 5vw, 60px)" }}>
              Sold before they land.
            </span>
          </h1>
          ...
          <p className="animate-fade-in-up anim-d3" style={{
            ...
            letting overseas buyers, investors, and tenants experience every room before booking
            a single flight.
          </p>
          ...
          <div className="animate-fade-in-up anim-d4" style={{ display: "flex", gap: 12, flexWrap: "wrap", marginBottom: 56 }}>
            ...
            <a href="#how-it-works" className="btn btn-outline" style={{ fontSize: 15, padding: "13px 28px" }}>
              See how it works
            </a>
          </div>

          {/* Social proof bar */}
          <div className="animate-fade-in-up anim-d5" style={{
        ...
        <div style={{
          ...
          <div className="card" style={{ overflow: "hidden" }}>
            ...
            <div style={{ padding: "16px 20px" }}>
              <div style={{ fontSize: 13, fontWeight: 600, marginBottom: 4 }}>The Residence — Canary Wharf</div>
              <div style={{ fontSize: 12, color: "var(--text2)" }}>3 bed · 1,240 sq ft · £895,000</div>
            </div>
          </div>
        </div>
      </div>
