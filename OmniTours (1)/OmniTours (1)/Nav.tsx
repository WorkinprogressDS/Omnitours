      ...
      <div className="container" style={{ display: "flex", alignItems: "center", justifyContent: "space-between", height: 64 }}>
        ...
        <Link href="/" style={{ textDecoration: "none", display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <span style={{
            ...
            color: "var(--text)",
            letterSpacing: "-0.3px",
          }}>OmniTour<span style={{ color: "var(--accent)" }}>.ai</span></span>
        </Link>

        {/* Desktop links */}
        <div style={{ display: "flex", alignItems: "center", gap: 8 }} className="desktop-nav">
          {["How it works", "Pricing", "For agents", "View demo"].map((label, i) => (
            <a key={i} href={`#${label.toLowerCase().replace(/ /g, "-")}`} className="btn btn-ghost"
              style={{ fontSize: 13 }}>
              {label}
            </a>
          ))}
        ...
        <div style={{
          ...
          {["How it works", "Pricing", "For agents", "View demo"].map((label, i) => (
            <a key={i} href={`#${label.toLowerCase().replace(/ /g, "-")}`}
              ...
              style={{
                display: "block", padding: "12px 0", color: "var(--text2)",
                textDecoration: "none", fontSize: 15, borderBottom: "1px solid var(--border)",
